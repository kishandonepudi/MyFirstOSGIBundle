        ...
        %><div class="cq-carousel">
            ...
            <div class="cq-carousel-banners" >
                ...
                <div style="${loop.first ? "left: 0px; opacity: 1;" : "left: -1000px; opacity: 0;"}" id="${slide.name}" class="cq-carousel-banner-item">
                    ...
                    <h3>${slide.title}</h3>
                    <p>${slide.desc}<br<%= xs %>>
                        <img src="/etc/designs/default/0.gif" style="background-image:url(/etc/designs/centillion_design/clientlibs/css/images/Drone.jpg)" alt="${slide.title}"<%= xs %>><a href="${slide.path}.html">Read More</a>
                    </p>
                </div>
                </c:forEach>
            </div>
