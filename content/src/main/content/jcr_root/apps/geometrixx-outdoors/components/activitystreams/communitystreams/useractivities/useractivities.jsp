...
<%
    ...
    String communityPath = GroupUtil.getCommunityRootPagePath(resourceResolver, resource.getPath());
    String streamPath = CollabUtil.resourceToUGCPath(resourceResolver.getResource(communityPath));
