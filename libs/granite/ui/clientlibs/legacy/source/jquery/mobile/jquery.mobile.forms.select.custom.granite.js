	...
	var extendSelect = function( widget ){
		...
		var select = widget.select,
			...
			menuPage = $( "<div data-" + $.mobile.ns + "role='dialog' data-" +$.mobile.ns + "theme='"+ widget.options.theme +"' data-" +$.mobile.ns + "overlay-theme='"+ widget.options.overlayTheme +"'>" +
				...
				"</div>" ).appendTo( thisPage.closest( ".ui-mobile-viewport" ) ).page(),
				//GRANITE:END
		...
		$.extend( widget, {
			...
			open: function() {
				...
				//GRANITE:START
				var viewport = self.list.parents(".ui-mobile-viewport");
				var viewportTop = viewport.offset().top;
				var viewportLeft = viewport.offset().left;
				var content = self.button.parents(".ui-content");
				//TODO assume content is the one who scroll, not elegant: splitview specific
				scrollTop = content.scrollTop();
				var gapTop = content.offset().top - viewportTop;
				screenHeight = content.innerHeight();
...
//						.removeClass( "ui-screen-hidden" );
					self.screen.height( viewport.height() )
						.removeClass( "ui-screen-hidden" );
					//GRANITE:END
					...
					var roomtop = btnOffset - scrollTop,
						...
						newtop, newleft;
					//GRANITE:START
					roomtop = btnOffset - viewportTop - gapTop;
					roombot = screenHeight - roomtop;
					//GRANITE:END
					...
					if ( roomtop > menuHeight / 2 && roombot > menuHeight / 2 ) {
						...
						newtop = roomtop > roombot ? gapTop + screenHeight - menuHeight - 30 : gapTop + 30;
						//GRANITE:END
					}
